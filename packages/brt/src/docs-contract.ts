...
const documentation: BrtDocsContract['documentation'] = {
  ...
  criticalOptions: {
    ...
    'workflows list': ['dev', 'limit', 'nextToken', 'status'],
    'workflows show': ['dev', 'includeData', 'steps'],
    'workflows wait': ['dev', 'includeData', 'steps', 'timeout'],
  ...
  criticalUsages: {
    ...
    'workflows run': ['<name>'],
    'workflows show': ['<workflowId>'],
    'workflows wait': ['<workflowId>'],
    eval: ['[name]'],
    'eval run': ['[name]'],
    'eval runs': ['[runId]'],
  },
  requirements: [
    ...
    {
      id: 'one-shot-agent-scripts',
      assertion:
        'brt run is a one-shot local script process over the selected agent context; brt dev remains the long-lived worker, watch, tunnel, and callback command',
      documents: ['overview', 'reference'],
    },
    {
      id: 'durable-workflow-observation',
      assertion:
  ...
  workflows: [
    ...
    },
    {
      ...
      documents: ['overview', 'reference'],
      commandPaths: ['workflows run', 'workflows list', 'workflows show', 'workflows wait'],
    },
    {
      id: 'hosted-evals',
      documents: ['overview', 'reference'],
