...
- Обновлены внутренние зависимости: @holocronlab/botruntime-client@1.55.0
- Обновлены внутренние зависимости: @holocronlab/botruntime-cognitive@0.8.12
- Обновлены внутренние зависимости: @holocronlab/botruntime-evals@2.1.33
- Обновлены внутренние зависимости: @holocronlab/botruntime-llmz@0.1.13
- Обновлены внутренние зависимости: @holocronlab/botruntime-sdk@6.20.0
- Обновлены внутренние зависимости: @holocronlab/botruntime-zai@2.8.16

## 2.9.4 — 2026-07-27

- Обновлены внутренние зависимости: @holocronlab/botruntime-client@1.54.1
- Обновлены внутренние зависимости: @holocronlab/botruntime-cognitive@0.8.11
- Обновлены внутренние зависимости: @holocronlab/botruntime-evals@2.1.32
- Обновлены внутренние зависимости: @holocronlab/botruntime-llmz@0.1.12
- Обновлены внутренние зависимости: @holocronlab/botruntime-sdk@6.19.7
- Обновлены внутренние зависимости: @holocronlab/botruntime-zai@2.8.15
...
- Kept the hosted runtime on the same release line as botruntime ADK for the
agents-as-code script and durable workflow tooling release.
...
- Обновлены внутренние зависимости: @holocronlab/botruntime-llmz@0.1.9
- Обновлены внутренние зависимости: @holocronlab/botruntime-sdk@6.19.2
- Обновлены внутренние зависимости: @holocronlab/botruntime-zai@2.8.12
...
- Обновлены внутренние зависимости: @holocronlab/botruntime-llmz@0.1.8
- Обновлены внутренние зависимости: @holocronlab/botruntime-sdk@6.19.0
- Обновлены внутренние зависимости: @holocronlab/botruntime-zai@2.8.11
