import { Cognitive, CognitiveBeta, type BotpressClientLike, Models } from '@holocronlab/botruntime-cognitive'
...
export type ExecutionProps = {
  ...
  /**
   * An instance of a botruntime Client, an instance of Cognitive Client (@holocronlab/botruntime-cognitive),
   * or a standalone CognitiveBeta client.
   * This is used to generate content using the LLM and to access the botruntime API.
