...
import {
  JexInvalidJsonSchemaError,
  JexUnsupportedJsonSchemaError,
  JexUnsuportedJsonSchemaError
} from '../errors'
...
test('JexIR should retain the legacy unsupported-schema error export', () => {
  expect(JexUnsuportedJsonSchemaError).toBe(JexUnsupportedJsonSchemaError)
})
