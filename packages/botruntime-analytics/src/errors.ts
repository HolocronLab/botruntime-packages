/**
 * Shared base error for ADK packages. Lives in this dependency-light package
 * every surface already shares (cli, adk, ui) — so all typed errors can
 * genuinely inherit one base instead of mirroring its shape.
 *
